...
class RelazioneIncorporamentoController extends Controller
{
  public function relazioneAnno()
  {
    ...
    switch (Auth::user()->tipo_utente) {
      case '1':
        return view('corsi.admin.resoconti.relazioneFineIncorporamento', ['Anni' => $allievi, 'area' => $area, 'regione' => $regione]);

      case '2':
        return view('corsi.adminJ.resoconti.relazioneFineIncorporamento', ['Anni' => $allievi, 'area' => $area, 'regione' => $regione]);

      case '3':
        return view('corsi.addetto.resoconti.relazioneFineIncorporamento', ['Anni' => $allievi, 'area' => $area, 'regione' => $regione]);
    }
