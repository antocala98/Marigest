...
@section('breadc')
    <li>
        <div class="flex items-center">
            ...
            &nbsp;
            <a href="{{ url('corsi/22-nmrs/admin/sezione-sanitaria/inserisci-provvedimento-sanitario') }}"
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                ...
                <div class="mt-4">
                    ...
                    <select id="tipo_provvedimento" name="tipo_provvedimento" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        ...
                        <option value="deg_conv">Rip.domiciliare/Convalescenza</option>
                ...
                <div class="mt-4">
                    ...
                    <input  type="number" id="num_giorni" name="num_giorni" min="1" max="15" step="1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
                </div>
                <div class="mt-4">
