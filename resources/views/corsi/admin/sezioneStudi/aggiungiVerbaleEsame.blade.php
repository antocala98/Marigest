...
<?php } ?>
        ...
        <div class=" block md:flex md:justify-center">
            ...
            <div class="w-full md:w-2/6 sm:mx-1 mt-12 px-6 py-2 bg-white shadow-md overflow-hidden sm:rounded-lg">
                ...
                <div class="mt-4">
                    ...
                    <input type="text" id="voto" name="voto" min="0" max="30" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                <div class="mt-4">
    ...
    <datalist id="materie">
        @foreach ($materie as $materia)
            @if ($materia->facolta==='dipartimento')
            <option value="{{$materia->codice}}">{{$materia->nome}}-{{$materia->facolta}}-{{$materia->sessione}}-{{$materia->classe}} classe</option>
            @else
