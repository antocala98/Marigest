...
@section('breadc')
    <li>
        <div class="flex items-center">
            ...
            <a href="{{url('corsi/marescialli/admin/schede-ripielogative')}}" class="inline-flex items-center text-sm font-medium text-white hover:scale-110 dark:text-gray-400 dark:hover:text-white">Schede Ripielogative</a>
        </div>
    </li>
@endsection
@section('body')
