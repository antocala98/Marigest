...
<div class="pl-10 pt-10 pb-10 grid grid-cols-1 gap-4 md:grid md:grid-cols-2 lg:grid lg:grid-cols-3">
    <div div class="mb-6 p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <a href="{{url('corsi/marescialli/admin/schede-riepilogative/Relazione-fine-incorporamento')}}" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Inserisci Risultati
