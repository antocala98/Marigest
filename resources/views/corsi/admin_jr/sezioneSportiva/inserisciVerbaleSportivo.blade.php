...
@section('breadc')
    <li>
        <div class="flex items-center">
            ...
            <a href="{{url('corsi/marescialli/adminJ/sezione-studi')}}" class="inline-flex items-center text-sm font-medium text-white hover:scale-110 dark:text-gray-400 dark:hover:text-white">Sezione Studi</a>
        </div>
    </li>
    <li>
        <div class="flex items-center">
            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
            <a href="{{url('corsi/marescialli/adminJ/sezione-sportiva/inserisci-verbali-sportivi')}}" class="inline-flex items-center text-sm font-medium text-white hover:scale-110 dark:text-gray-400 dark:hover:text-white">Verbali Esami</a>
        </div>
    </li>
@endsection
@section('body')
    ...
    <form method="POST" action="#" id="form" enctype="multipart/form-data">
        ...
        <div class=" block md:flex md:justify-center">
            <div class="w-full md:w-2/6  sm:mx-1 mt-12 px-6 py-2 bg-white shadow-md overflow-hidden sm:rounded-lg">
                ...
                <div class="mt-4">
                    <label for="discipline" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Disciplina</label>
                    <input list="discipline" type="text" name="discipline" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                <div class="mt-4">
