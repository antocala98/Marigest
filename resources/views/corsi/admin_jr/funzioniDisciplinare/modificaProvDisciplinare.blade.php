...
@section('breadc')
    <li>
        <div class="flex items-center">
            ...
            <a href="{{ url('corsi/marescialli/adminJ/sezione-disciplinare') }}"
            ...
            &nbsp;
            <a href="{{ url('corsi/marescialli/adminJ/sezione-disciplinare/modifica-provvedimento-disciplinare') }}"
...
@section('body')
    ...
    <form method="POST" action="{{ route('aggiornaProvDAdminJunior') }}" enctype="multipart/form-data">
    @csrf
