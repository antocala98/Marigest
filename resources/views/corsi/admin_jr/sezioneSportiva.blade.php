...
@section('breadc')
    <li>
        <div class="flex items-center">
            ...
            <a href="{{url('corsi/marescialli/adminJ/sezione-sportiva')}}"
...
@section('body')
    <div class="pl-10 pt-10 pb-10 grid grid-cols-1 gap-4 md:grid md:grid-cols-2 lg:grid lg:grid-cols-3">
        <div div class="mb-6 p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Verbali Sportivi</h5>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">In questa sezione è possibile inserire i risultati conseguiti nei minimi sportivi</p>
            <a href="{{url('corsi/marescialli/adminJ/sezione-sportiva/inserisci-verbali-sportivi')}}" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Inserisci Risultati
