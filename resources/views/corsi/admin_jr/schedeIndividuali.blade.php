...
@section('breadc')
    <li>
        <div class="flex items-center">
            ...
            <a href="{{url('corsi/marescialli/adminJ/schede-individuali')}}" class="inline-flex items-center text-sm font-medium text-white hover:scale-110 dark:text-gray-400 dark:hover:text-white">Schede Individuali allievi</a>
        </div>
    </li>
@endsection
@section('body')
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="p-4">
            ...
            <div class="relative mt-1">
                ...
                <form action="{{url('corsi/marescialli/adminJ/schede-individuali')}}" method="POST" class="flex items-center">
                    @csrf
