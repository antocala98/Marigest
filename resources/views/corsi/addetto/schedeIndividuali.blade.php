...
@section('breadc')
    <li>
        <div class="flex items-center">
            ...
            <a href="{{url('corsi/marescialli/addetto/schede-individuali')}}" class="inline-flex items-center text-sm font-medium text-white hover:scale-110 dark:text-gray-400 dark:hover:text-white">Schede Individuali allievi</a>
        </div>
    </li>
@endsection
@section('body')
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="p-4">
            ...
            <div class="relative mt-1">
                ...
                <form action="{{url('corsi/marescialli/addetto/schede-individuali')}}" method="POST" class="flex items-center">
                    @csrf
                    ...
                    @foreach ($allievi as $allievo)
                        <tr id="accordion-collapse" data-accordion="collapse" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('visualizzaSchedaAddetto', ['id' => $allievo->id ]) }} " class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Visualizza PDF</a>
                            </td>
