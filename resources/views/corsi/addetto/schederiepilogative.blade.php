...
@section('breadc')
    <li>
        <div class="flex items-center">
            ...
            <a href="{{url('corsi/marescialli/addetto/schede-ripielogative')}}" class="inline-flex items-center text-sm font-medium text-white hover:scale-110 dark:text-gray-400 dark:hover:text-white">Schede Ripielogative</a>
        </div>
    </li>
@endsection
@section('body')
<div class="pl-10 pb-10 grid grid-cols-1 gap-4 md:grid md:grid-cols-2 lg:grid lg:grid-cols-3">
    ...
    <a href="{{url('corsi/marescialli/addetto/schede-riepilogative/Relazione-fine-incorporamento')}}" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
