                    ...
                    <div id="navWrapper"
                        ...
                        <nav id="nav"
                            ...
                            <ul class="mb-0 list-unstyled">
                                <li class="mt-8">
                                    <a href="{{ url('corsi/marescialli/admiJ/home') }}"
                                    ...
                                    <ul class="py-1 list-unstyled fw-normal small">
                                        <li>
                                            <a href="{{ url('corsi/marescialli/admiJ/sezione-disciplinare') }}"
                                            ...
                                            <ul>
                                                <li><a href="{{ url('corsi/marescialli/admiJ/sezione-disciplinare/inserisci-provvedimento-disciplinare') }}"
                                                ...
                                                <li><a href="{{ url('corsi/marescialli/admiJ/sezione-disciplinare/modifica-provvedimento-disciplinare') }}"
                                                        ...
                                                        provvedimento disciplinare</a></li>
                                                <li><a href="{{ url('corsi/marescialli/admiJ/sezione-disciplinare/visualizza-provvedimento-disciplinare') }}"
                                        ...
                                        <br>
                                        <li>
                                            <a href="{{ url('corsi/marescialli/admiJ/sezione-sanitaria') }}"
                                            ...
                                            <ul>
                                                <li><a href="{{ url('corsi/marescialli/admiJ/sezione-sanitaria/inserisci-provvedimento-sanitario') }}"
                                                        class="py-2 transition-colors duration-200 relative block hover:text-gray-900 text-gray-500 dark:text-gray-400 dark:hover:text-white ">Inserisci
                                                        provvedimento sanitario</a></li>
                                                <li><a href="{{ url('corsi/marescialli/admiJ/sezione-sanitaria/modifica-provvedimento-sanitario') }}"
                                                        class="py-2 transition-colors duration-200 relative block hover:text-gray-900 text-gray-500 dark:text-gray-400 dark:hover:text-white ">Modifica
                                                        provvedimento sanitario</a></li>
                                                <li><a href="{{ url('corsi/marescialli/admiJ/sezione-sanitaria/visualizza-provvedimento-sanitario') }}"
                                                        class="py-2 transition-colors duration-200 relative block hover:text-gray-900 text-gray-500 dark:text-gray-400 dark:hover:text-white ">Visualizza
                                                        provvedimento sanitario</a></li>
                                            </ul>
                                        </li>
                                        <br>
                                        <li>
                                            <a href="{{ url('corsi/marescialli/admiJ/sezione-studi') }}"
                                                ...
                                                studi</b></a>
                                            <ul>
                                                <li><a href="{{ url('corsi/marescialli/admiJ/sezione-studi/inserisci-verbali-esami')}}" class="py-2 transition-colors duration-200 relative block hover:text-gray-900 text-gray-500 dark:text-gray-400 dark:hover:text-white ">Verbali esami</a></li>
                                            </ul>
                                        </li>
                                        <br>
                                        <li>
                                            <a href="{{ url('corsi/marescialli/admiJ/sezione-sportiva') }}"
                                                class="py-2 transition-colors duration-200 relative block hover:text-gray-900 text-gray-500 dark:text-gray-400 dark:hover:text-white "><b>Sezione
                                                sportiva</b>
                                            </a>
                                            <ul>
                                                <li><a href="{{ url('corsi/marescialli/admiJ/sezione-sportiva/inserisci-verbali-sportivi')}}" class="py-2 transition-colors duration-200 relative block hover:text-gray-900 text-gray-500 dark:text-gray-400 dark:hover:text-white ">Verbali sportivi</a></li>
                                            </ul>
                                        </li>
                                </li>
                                <li class="mt-8">
                                    <a href="{{ url('corsi/marescialli/admiJ/aggiungi-dati-corsi') }}"
                                        class="mb-2 text-sm font-semibold tracking-wide text-gray-900 uppercase lg:text-xs dark:text-white">
                                ...
                                <li class="mt-8">
                                    <a href="{{ url('corsi/marescialli/admiJ/schede-individuali') }}"
                                        class="mb-2 text-sm font-semibold tracking-wide text-gray-900 uppercase lg:text-xs dark:text-white">
                                        <br>SCHEDE INDIVIDUALI ALLIEVI</h5> </a>
                                </li>
                                <li class="mt-8">
                                    <a href="{{ url('corsi/marescialli/admiJ/schede-riepilogative') }}"
                                        class="mb-2 text-sm font-semibold tracking-wide text-gray-900 uppercase lg:text-xs dark:text-white">
                                        <br>SCHEDE RIEPILOGATIVE</h5> </a>
                                        <li>
                                            <a href="{{ url('corsi/marescialli/admiJ/schede-riepilogative/Relazione-fine-incorporamento') }}"
                                                class="py-2 transition-colors duration-200 relative block hover:text-gray-900 text-gray-500 dark:text-gray-400 dark:hover:text-white ">
                                ...
                                <li class="mt-8">
                                    <a href="{{ url('corsi/marescialli/admiJ/modifica-dati-allievi') }}"
                                        class="mb-2 text-sm font-semibold tracking-wide text-gray-900 uppercase lg:text-xs dark:text-white">
